...
public class FavoQaFrag extends Fragment{

	   String[] titles={"小米4性能如何，值得入手吗？","乐视电视怎么样？有详细解释吗","三星s6有几个配置？",
	    		};  
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View newsLayout = inflater.inflate(R.layout.tab_favoqa, container,
               false);  
		 ...
		 Button goQue = (Button) newsLayout.findViewById(R.id.favoqa_goque);
	...
	public static FavoQaFrag newInstance() {
		// TODO Auto-generated method stub
		return new FavoQaFrag();
	}
