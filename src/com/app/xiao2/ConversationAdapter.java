...
public class ConversationAdapter extends BaseAdapter {
	...
	public ConversationAdapter(Context context, LinkedList<Bean> beans) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			switch (type) {
			case TYPE_0:
				convertView = li.inflate(R.layout.conversation_item_me, null);
				break;
			case TYPE_1:
				convertView = li.inflate(R.layout.conversation_item_you, null);
				break;
			}
